...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        _index2.default.getVideo({ count: 2 }).then(function (_ref) {
            ...
            _this.video_1 = data.data[0];
            _this.video_2 = data.data[1];
        });
    },
...
var _wxcOverlay = __webpack_require__(54);
